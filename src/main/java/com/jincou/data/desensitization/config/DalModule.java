 ...
 */
package com.jincou.data.desensitization.config;


import com.alibaba.druid.pool.DruidDataSource;
import com.jincou.data.desensitization.plugin.DesensitizationInterceptor;
...
@MapperScan(basePackages = "com.jincou.data.desensitization.mapper")
